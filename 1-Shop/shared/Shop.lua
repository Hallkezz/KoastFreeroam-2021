    ...
    self.items = {
        ...
        [self.types["Персонаж"]] = {
            ...
            ["Мальчики"] = {
				...
				ModelBuyMenuEntry( 78, "Босс Бандит" ),
        ...
        [self.types["Внешность"]] = {
            { "Головные Уборы", "Колпаки и Шлемы", "Платки", "Волосы", "Лицо", "Шея", "Принадлежности", "*VIP*" },

            ["Головные Уборы"] = {
				AppearanceBuyMenuEntry( "Clear", "Head", "ОЧИСТИТЬ" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_female2.eez/pd_arcticvillage_female_2-hat_winter.lod", "Head", "Арктическая Льняная Шляпа" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_male2.eez/pd_arcticvillage_male_2-hat_winter.lod", "Head", "Арктическая Льняная Шляпа - Большая" ),
				AppearanceBuyMenuEntry( "pd_generic_male_2.eez/pd_generic_male_2-hat_linen.lod", "Head", "Льняная Шляпа - Белая" ),
				AppearanceBuyMenuEntry( "pd_generic_male_3.eez/pd_generic_male_3-hat_linen.lod", "Head", "Льняная Шляпа - Пятна" ),
				AppearanceBuyMenuEntry( "pd_generic_female_1.eez/pd_generic_female_1-hat_linen.lod", "Head", "Льняная Шляпа - Черная Полоса" ),
				AppearanceBuyMenuEntry( "pd_generic_male_1.eez/pd_generic_male_1-hat_linen.lod", "Head", "Льняная Шляпа - Большая Темная Полоса" ),
				AppearanceBuyMenuEntry( "pd_generic_female_2.eez/pd_generic_female_2-hat_linen.lod", "Head", "Льняная Шляпа - Белая Полоса" ),
				AppearanceBuyMenuEntry( "pd_generic_female_5.eez/pd_generic_female_5-hat_cloth.lod", "Head", "Льняная Шляпа - Чёрный и Белый" ),
				AppearanceBuyMenuEntry( "pd_fishervillage_male1.eez/pd_fishervillage_male-hat_fisherman.lod", "Head", "Рыболовная Шляпа" ),
				AppearanceBuyMenuEntry( "pd_generic_female_1.eez/pd_generic_female_1-hat_fisherman.lod", "Head", "Рыболовная Шляпа - Маленькая" ),
				AppearanceBuyMenuEntry( "pd_tourist_male1.eez/pd_tourist_male-fisherhat.lod", "Head", "Fishing Floppy Hat Slanted" ),
				AppearanceBuyMenuEntry( "pd_generic_male_1.eez/pd_generic_male_1-hat_fisherman.lod", "Head", "Рыболовная Шляпа - Маленькая" ),
				AppearanceBuyMenuEntry( "pd_fishervillage_male1.eez/pd_fishervillage_male-ricehat.lod", "Head", "Worker Ricehat Big - Загар" ),
				AppearanceBuyMenuEntry( "pd_generic_female_5.eez/pd_generic_female_5-hat_straw2.lod", "Head", "Worker Ricehat - Загар" ),
				AppearanceBuyMenuEntry( "pd_generic_female.eez/generic_female-ricehat.lod", "Head", "Worker Ricehat Level - Бежевый" ),
				AppearanceBuyMenuEntry( "pd_generic_female_3.eez/pd_generic_female_3-hat_straw2.lod", "Head", "Worker Ricehat - Бежевый" ),
				AppearanceBuyMenuEntry( "pd_generic_female_1.eez/pd_generic_female_1-hat_rice.lod", "Head", "Рабочая Соломенная Шляпа" ),
				AppearanceBuyMenuEntry( "pd_generic_male_1.eez/pd_generic_male_1-hat_rice.lod", "Head", "Рабочая Соломенная Шляпа - Большая" ),
				AppearanceBuyMenuEntry( "pd_generic_female_2.eez/pd_generic_female_2-hat_rice.lod", "Head", "Рабочая Соломенная Шляпа - Желтый" ), 
				AppearanceBuyMenuEntry( "pd_generic_male.eez/pd_generic_male-hat.lod", "Head", "Рабочая Соломенная Шляпа - Светлая" ),
				AppearanceBuyMenuEntry( "pd_thugs1.eez/pd_thugs-h_bandana.lod", "Head", "Бандана Череп - Серый" ),
				AppearanceBuyMenuEntry( "pd_ms_doorman.eez/pd_doorman-h_bandana.lod", "Head", "Бандана Череп - Изношенный Серый" ),
				AppearanceBuyMenuEntry( "pd_generic_male_2.eez/pd_generic_male_2-hat_fedora.lod", "Head", "Федора - Светло-Серый" ),
				AppearanceBuyMenuEntry( "pd_ms_strippers_male1.eez/pd_ms_stripper_male-hat.lod", "Head", "Федора - Наклоненный" ),
				AppearanceBuyMenuEntry( "pd_ms_thugboss.eez/pd_executioner-h_felthat.lod", "Head", "Felt Федора - Наклоненный Серый" ),
				AppearanceBuyMenuEntry( "pd_roacheselite1.eez/pd_roaches_elite-h_headwear.lod", "Head", "Тараканы - Элитный Турбан" ),
				AppearanceBuyMenuEntry( "pd_generic_female_2.eez/pd_generic_female_2-hat_towel.lod", "Head", "Ткань Турбан" ),
            },
			
            ["Колпаки и Шлемы"] = {
				AppearanceBuyMenuEntry( "Clear", "Head", "ОЧИСТИТЬ" ),
				AppearanceBuyMenuEntry( "pd_tourist_male1.eez/pd_tourist_male-keps.lod", "Head", "Keppy Шляпа" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_male1.eez/pd_arcticvillage_male-hat.lod", "Head", "Артикул Шляпа" ),
				...
				AppearanceBuyMenuEntry( "pd_oilplatform_male1.eez/pd_oilplatform-greycap.lod", "Head", "Масляный Рабочий Шапочка - Серый" ),
				AppearanceBuyMenuEntry( "pd_oilplatform_male1.eez/pd_oilplatform-helmet.lod", "Head", "Буровой Рабочий, Каска - Жётый" ),
				AppearanceBuyMenuEntry( "pd_ms_strippers_female1.eez/pd_stripper_female-ht_militarycap.lod", "Head", "Военный Командир" ),
				AppearanceBuyMenuEntry( "pd_reaperselite1.eez/pd_reapers_elite_male-cap.lod", "Head", "Элитная Крышка Жнецов" ),
				AppearanceBuyMenuEntry( "pd_ms_japaneseveterans.eez/pd_ms_japaneseveterans-hat.lod", "Head", "Японская Крышка" ),
				...
				AppearanceBuyMenuEntry( "pd_panaupolice.eez/panaupolice-cap.lod", "Head", "Полицейский Колпачок Панау" ),
				AppearanceBuyMenuEntry( "pd_panaupolice.eez/panaupolice-helmet.lod", "Head", "Полицейский Шлем Панау" ),
				AppearanceBuyMenuEntry( "pd_panaupolice.eez/panaupolice-turban.lod", "Head", "Полиция Панау Турбан" ),
				AppearanceBuyMenuEntry( "pd_gov_elite.eez/pd_govnewfix_elite-helmet.lod", "Head", "Элитный Шлем Правительства" ),
				AppearanceBuyMenuEntry( "pd_gov_base01.eez/pd_gov_base-beret.lod", "Head", "Правительственная Элита Берет" ),
				AppearanceBuyMenuEntry( "pd_reaperselite1.eez/pd_reapers_elite_male-beret.lod", "Head", "Жнецы - Элитный Берет" ),
				AppearanceBuyMenuEntry( "pd_roacheselite1.eez/pd_roaches_elite-h_bandana.lod", "Head", "Тараканы - Элитный Берет" ),
            },
			
            ["Платки"] = {
				AppearanceBuyMenuEntry( "Clear", "Covering", "ОЧИСТИТЬ" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_female1.eez/pd_arcticvillage_female-headcloth.lod", "Covering", "Headcloth - Black" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_female1.eez/pd_arcticvillage_female-headcloth2.lod", "Covering", "Headcloth - White & Dark" ),
				AppearanceBuyMenuEntry( "pd_desertvillage_female1.eez/pd_desertvillage_female-shawl.lod", "Covering", "Headcloth - White" ), 
				AppearanceBuyMenuEntry( "pd_desertvillage_male1.eez/pd_desertvillage_male-turban.lod", "Covering", "Headcloth & Turban" ),
				AppearanceBuyMenuEntry( "pd_generic_female.eez/generic_female-shawl.lod", "Covering", "Headcloth Beige" ), 
				AppearanceBuyMenuEntry( "pd_generic_female_3.eez/pd_generic_female_3-hat_scarf.lod", "Covering", "Bonnet - Light" ), 
				AppearanceBuyMenuEntry( "pd_generic_female_5.eez/pd_generic_female_5-hat_scarf.lod", "Covering", "Bonnet - Dark" ),
            },

            ["Волосы"] = {
				AppearanceBuyMenuEntry( "Clear", "Hair", "ОЧИСТИТЬ" ),
				AppearanceBuyMenuEntry( "pd_tourist_female2.eez/pd_tourist_female-h_hair.lod", "Hair", "Средний - Чёрный" ),
				AppearanceBuyMenuEntry( "pd_ms_strippers_female1.eez/pd_stripper_female-h_hair1.lod", "Hair", "Средний - Серый" ),
				AppearanceBuyMenuEntry( "pd_arcticvillage_female_lod1-dress_col.pfx", "Hair", "Короткий - Оранжевый" ),
            },
            ...
            ["Лицо"] = {
				...
				AppearanceBuyMenuEntry( "pd_ularboyselite1.eez/pd_ularboys_elite_male-glasses.lod", "Face", "Непрозрачные Солнцезащитные Очки - Тёмные" ),
				AppearanceBuyMenuEntry( "pd_blackhand.eez/pd_blackhand-glasses.lod", "Face", "Непрозрачные Солнцезащитные Очки - Светлые" ),
            ...
            ["Шея"] = {
				...
				AppearanceBuyMenuEntry( "pd_ms_civ_strippers_male2.eez/pd_civilian_stripper_male-cowboyscarf.lod", "Neck", "Красный Шарф" ),
				AppearanceBuyMenuEntry( "pd_ms_strippers_male2.eez/pd_ms_stripper_male-cowboyscarf.lod", "Neck", "Ковбойский Шарф" ),
				AppearanceBuyMenuEntry( "pd_blackmarket.eez/pd_blackmarket-scarf.lod", "Neck", "Чёрнокнижковый Шарф" ),
            },
            ...
            ["Принадлежности"] = {
				...
				AppearanceBuyMenuEntry( "pd_gov_base02.eez/pd_gov_base-bags.lod", "Back", "Рюкзак для Спецодежды" ),
				AppearanceBuyMenuEntry( "pd_gov_elite.eez/pd_govnewfix_elite-vest1.lod", "Back", "Баллистический Жилет 1" ),
				AppearanceBuyMenuEntry( "pd_gov_elite.eez/pd_govnewfix_elite-vest2.lod", "Back", "Баллистический Жилет 2" ),
				AppearanceBuyMenuEntry( "pd_ularboysbase1.eez/pd_ularboys_base_male-ammopouch.lod", "Back", "Боеприпасы" ),
				AppearanceBuyMenuEntry( "pd_ularboysbase1.eez/pd_ularboys_base_male-waterbottle.lod", "Back", "Военная Бутылка Воды" ),
			},
			...
			["*VIP*"] = {
				...
				AppearanceBuyMenuEntry( "City_T01_SakuraL-TrunkA.lod", "Back", "Дерево", 1 ),
