...
function Grenades:ToggleGrenades( args )
...
function Grenades:Render()
	...
	if LocalPlayer:GetValue("exp") ~= 0 and LocalPlayer:GetValue("exp") ~= nil and self.FadeOutTimer then
		...
		local pos_2d_text = Vector2( Render.Size.x / tpos - (Render:GetTextWidth(text, self.textb:GetSize().y/0.013 / Render:GetTextWidth( "BTextResoliton" ) )) - imga:GetSize().x/2, (Render.Height - Render.Height * 0.18) - self.textb:GetSize().y/2 )
		...
		if Game:GetSetting(4) >= 1 then
			...
			Render:DrawText( pos_2d_text + Vector2.One, text, Color( 0, 0, 0, Game:GetSetting(4) * 2.25 ), self.textb:GetSize().y/0.016 / Render:GetTextWidth( "BTextResoliton" ) )
			Render:DrawText( pos_2d_text, text, Color( 255, 255, 255, Game:GetSetting(4) * 2.25 ), self.textb:GetSize().y/0.016 / Render:GetTextWidth( "BTextResoliton" ) )
