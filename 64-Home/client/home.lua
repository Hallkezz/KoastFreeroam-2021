...
function Home:__init()
	...
	Network:Subscribe( "FailedSetHome", self, self.FailedSetHome )
end
...
function Home:FailedSetHome()
	Events:Fire( "CastCenterText", { text = "Недостаточно средств. Требуется $1.500!", time = 3, color = Color.Red } )
end
