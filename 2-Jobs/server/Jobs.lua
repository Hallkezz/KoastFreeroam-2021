		...
		for player in Server:GetPlayers() do
			...
			if self.jobsToCancel[pId] == true then
				...
				if self.playerJobs[pId] and self.playerJobs[pId] ~= nil then
					if IsValid( self.playerJobs[pId].vehiclePointer ) and self.playerComps[pId] == nil then
...
function PanauDrivers:PlayerCompleteJob( args, player )
	...
	if destDist < 20 and self.playerComps[playerId] == nil and stopped then
...
function PanauDrivers:ModuleUnload( args )
