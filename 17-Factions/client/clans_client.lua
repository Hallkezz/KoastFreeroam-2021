...
function ClanSystem:ModuleLoad()
	...
	self.createClan.dLabel:SetText( "Требуется $10.000, чтобы создать клан" )
	...
	self.clanMenu.searchEdit:Subscribe( "Focus", self, self.Focus )
	self.clanMenu.searchEdit:Subscribe( "Blur", self, self.Blur )
