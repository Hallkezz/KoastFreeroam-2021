...
function Nametags:Render()
	...
	if not LocalPlayer:GetValue( "TagHide" ) then
		...
		local textpos = Vector2( Render.Width / 4 - width/1.8 + Render:GetTextWidth( self.name, 18 ) / 15, 2 )

		Render:FillArea( Vector2( Render.Width/4 - width/1.8, 0 ), Vector2( Render:GetTextWidth( self.name, 18 ) + 5, Render:GetTextHeight( "/hidetag", 18 ) + 2 ), Color( 0, 0, 0, Game:GetSetting(4) * 2.25 / 2.4 ) )
		...
		Render:FillTriangle( Vector2( (Render.Width / 4 - width/1.8 + Render:GetTextWidth( self.name, 18 ) + 15), 0 ), Vector2( (Render.Width / 4 - width/1.8 + Render:GetTextWidth( self.name, 18 ) + 5), 0 ), Vector2( (Render.Width / 4 - width/1.8 + Render:GetTextWidth( self.name, 18 ) + 5 ), Render:GetTextHeight( "/hidetag", 18 ) + 2 ), Color( 0, 0, 0, Game:GetSetting(4) * 2.25 / 2.4 ) )
